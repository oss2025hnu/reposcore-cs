...
public class FileGenerator
{
    ...
    {
        GenerateChart generateChart = new GenerateChart(_scores, _repoName, _folderPath);
        generateChart.Generate();
    }

    public void GenerateCsv()
    {
        GenerateCsv generateCsv = new GenerateCsv(_scores, _repoName, _folderPath);
        generateCsv.Generate();
    }

    public void GenerateTable()
    {
        GenerateTable generateTable = new GenerateTable(_scores, _repoName, _folderPath);
        generateTable.Generate();
    }

    public void GenerateHtml()
    {
        GenerateHtml gnerateHtml = new GenerateHtml(_repoName, _folderPath);
        gnerateHtml.Generate();
    }

    public void GenerateStateSummary(RepoStateSummary summary)
    {
        GenerateStateSummary generateStateSummary = new GenerateStateSummary(_repoName, _folderPath);
        generateStateSummary.Generate(summary);
    }
